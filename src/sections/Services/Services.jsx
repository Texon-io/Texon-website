...
function Services() {
  ...
  return (
    <section
      id={`services`}
      className={` flex justify-between items-center min-h-screen max-lg:gap-6 px-[105px] max-lg:flex-col py-16`}
    >
      <div className={`services-text w-fit h-fit lg:h-full flex flex-col justify-center`}>
        ...
        {innerWidth >= 1024 ? (
            ...
            <div className={`relative w-3/6 h-3/5 top-1/2`}>
                <CardSwap
                    cardDistance={60}
            ...
            {cardsData.map((card) => (
                ...
                >
                    <div className="bg-main-black/75 p-3 rounded-t-2xl text-center -mt-8 mb-4 w-full border-0 border-b-[1px] border-gray-500 group-hover:border-gray-300/75 transition-colors duration-500">
                        <p className="text-sm font-medium">{card.feature}</p>
                    </div>
                    ...
                    <div className="text-center pb-8 relative px-2">
