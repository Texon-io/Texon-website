...
function Contact() {
  ...
  const handleClick = (service) => {
    if (service === "Custom") {
      setActiveServices((prev) => (prev.includes("Custom") ? [] : ["Custom"]));
      return;
    }
  ...
  return (
    <section id={`contact`} className={`mt-8`}>
      ...
      <div className={`flex-center mb-20`}>
        <h5
          className={`text-3xl sm:text-5xl font-semibold tracking-wider capitalize text-main-gray leading-14 text-center`}
        >
      ...
      {/*  Contact Form  */}
      <div className={`w-full px-8 lg:px-[105px] flex flex-col gap-6`}>
        <p className={`font-medium text-2xl`}>
          You got an Idea? Just
          <br />
          Tell us...
        </p>
