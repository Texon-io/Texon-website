...
function DashedHeading({ heading, headClass = "", para, paraClass = "" }) {
  ...
  return (
    <div ref={wrapperRef} className={`group py-5`}>
      <h4
        className={`dashed-head relative font-orbitron capitalize font-semibold text-[40px] tracking-[2px] w-full ${headClass}`}
      >
        {heading}
      ...
      <p
        className={`dashed-para tracking-[3%] font-light w-full opacity-0 translate-y-10`}
      >
        {para}
      </p>
    </div>
