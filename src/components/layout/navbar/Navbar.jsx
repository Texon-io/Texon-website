...
function Navbar() {
  ...
  return (
    <>
      <nav className="fixed inset-x-0 top-0 z-50 backdrop-blur-3xl h-16 px-6 lg:px-16 xl:px-[105px] mx-auto max-w-screen-2xl flex items-center justify-between border-b border-gray-500/35">
        <div>
